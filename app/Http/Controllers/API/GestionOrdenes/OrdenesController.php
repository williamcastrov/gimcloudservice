...
//exit;
        ...
        PDF::Image('/var/www/bc-gimservice/resources/js/server/server/src/images/logologistral.jpeg', 5, 5, 40, 20, 'JPG', 'http://www.tcpdf.org', '', true, 150, '', false, false, 0, false, false, false);
        $html = '
        <br/>
       ...
       PDF::Image('/var/www/bc-gimservice/public/images/'.$data[0]->name, 10, 145, 45, 45, 'JPG', 'http://www.tcpdf.org', '', true, 150, '', false, false, 0, false, false, false);
       }

       if(isset($data[1]->name)){
       PDF::Image('/var/www/bc-gimservice/public/images/'.$data[1]->name, 75, 145, 45, 45, 'JPG', 'http://www.tcpdf.org', '', true, 150, '', false, false, 0, false, false, false);
       }

       if(isset($data[2]->name)){
       PDF::Image('/var/www/bc-gimservice/public/images/'.$data[2]->name, 140, 145, 45, 45, 'JPG', 'http://www.tcpdf.org', '', true, 150, '', false, false, 0, false, false, false);
       }
     ...
     if(isset($data3[0])){
        ...
        $url = "/var/www/bc-gimservice/public/images/firmaOTCliente.".$ext[1];
        $ifp = fopen($url, "w");
        fwrite($ifp, $data);
        fclose($ifp);
     }
...
/*
      if(isset($data3[0])){
         ...
         $urlx = "/var/www/bc-gimservice/public/images/firmaOTTecnico.".$ext[1];
         $ifpx = fopen($urlx, "w");
         fwrite($ifpx, $datax);
         fclose($ifpx);
      }
