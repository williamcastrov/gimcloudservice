...
class EquiposController extends Controller
{
    ...
    public function listar_equipos(){  
      try {
        ...
        $data = DB::select("SELECT t0.*, t1.descripcion_fre, t3.razonsocial_cli, t4.descripcion_mar, t5.descripcion_grp,  
                            ...
                            FROM equipos as t0 INNER JOIN frecuencias AS t1	INNER JOIN interlocutores_cli as t3
                ...
                WHERE t0.frecuencia_equ     = t1.id_fre and t0.propietario_equ   = t3.id_cli  
    ...
    public function sumatotalequipos(){
      try {
        //Muestra Unicamente los tipos de interlocutores_cli PROVEEDORES = 1
